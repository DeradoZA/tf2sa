...
@Component({
	selector: 'app-demoman-stats',
	templateUrl: './demoman-stats.component.html',
	styleUrls: ['../stats.rank.scss'],
})
export class DemomanStatsComponent {
	...
	playersResult: GetDemomanStatsResult = {
		totalResults: 0,
	...
	ngAfterViewInit(): void {
		...
		merge(
			...
			.pipe(
				...
				switchMap(() => {
					this.isLoaded = false;
					return this.statsService.getDemomanStats(
