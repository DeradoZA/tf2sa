...
import { GetMedicStatsResult } from 'src/app/services/stats/getMedicStats';
import { StatsService } from 'src/app/services/stats/stats.service';

@Component({
	selector: 'app-medic-stats',
	templateUrl: './medic-stats.component.html',
	styleUrls: ['../stats.rank.scss'],
})
export class MedicStatsComponent {
	...
	playersResult: GetMedicStatsResult = {
		totalResults: 0,
	...
	ngAfterViewInit(): void {
		...
		merge(
			...
			.pipe(
				...
				switchMap(() => {
					this.isLoaded = false;
					return this.statsService.getMedicStats(
