...
CREATE TABLE
	IF NOT EXISTS ScoutAllTime (
		...
		SET
			...
			AverageDeaths FLOAT,
			AverageDamageTakenPM FLOAT,
			AverageHealsReceivedPM FLOAT,
			AverageMedKitsHP FLOAT,
			AverageCapturePointsCaptured FLOAT,
