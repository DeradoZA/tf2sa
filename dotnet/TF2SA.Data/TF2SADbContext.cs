...
namespace TF2SA.Data
{
    public partial class TF2SADbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.ClassStatsId)
                    .HasName("PRIMARY");

                entity.HasIndex(e => e.PlayerStatsId, "fk_playerstats_id");

                entity.Property(e => e.ClassStatsId)
                    .HasColumnType("int(10) unsigned")
                    .HasColumnName("ClassStatsID");

                entity.Property(e => e.Assists).HasColumnType("tinyint(3) unsigned");

                entity.Property(e => e.ClassId)
                    .HasColumnType("tinyint(3) unsigned")
                    .HasColumnName("ClassID");

                entity.Property(e => e.Damage).HasColumnType("mediumint(8) unsigned");
                ...
                entity.Property(e => e.Playtime).HasColumnType("smallint(5) unsigned");

                entity.HasOne(d => d.PlayerStats)
            ...
            modelBuilder.Entity<Game>(entity =>
            {
                ...
                entity.Property(e => e.BluScore).HasColumnType("tinyint(3) unsigned");
                ...
                entity.Property(e => e.RedScore).HasColumnType("tinyint(3) unsigned");
            });
            ...
            modelBuilder.Entity<PlayerStat>(entity =>
            {
                ...
                entity.Property(e => e.Airshots).HasColumnType("tinyint(3) unsigned");

                entity.Property(e => e.Backstabs).HasColumnType("tinyint(3) unsigned");

                entity.Property(e => e.DamageTaken).HasColumnType("mediumint(8) unsigned");
                ...
                entity.Property(e => e.Headshots).HasColumnType("tinyint(3) unsigned");

                entity.Property(e => e.Heals).HasColumnType("mediumint(8) unsigned");

                entity.Property(e => e.HealsReceived).HasColumnType("mediumint(8) unsigned");

                entity.Property(e => e.MedkitsHp)
            ...
            {
                entity.HasKey(e => new { e.PlayerStatsId, e.WeaponId })
                    .HasName("PRIMARY")
