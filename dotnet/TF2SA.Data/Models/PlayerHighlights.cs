...
namespace TF2SA.Data.Models
{
    ...
    {
        public PlayerHighlights(ulong steamID, uint? highestScoutDamage, byte? highestScoutKills, uint? highestSoldierDamage, byte? highestSoldierKills, byte? highestSoldierAirshots, uint? highestDemomanDamage, byte? highestDemomanKills, byte? highestDemomanAirshots, byte? highestDrops, uint? highestHeals, byte? highestUbers)
        {
