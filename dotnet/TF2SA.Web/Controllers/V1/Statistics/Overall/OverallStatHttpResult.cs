namespace TF2SA.Web.Controllers.V1.Statistics.Overall;

public class OverallStatHttpResult
{
	...
	public float? AverageHeadshots { get; set; }
	public float? AverageBackstabs { get; set; }
